    ...
    return (
        <div className='py-6 px-9'>
            <div className='max-w-screen-md mx-auto bg-white m-3 mt-6 flex flex-col py-6 px-9'>
                ...
                <Button className='w-full mb-2' label="Estudante" onClick={() => {
                    onTipoCadastroChange({ isProfessor: false, isCoordenador: false });
                    setActiveIndex(2);
                }} />
                <Button className='w-full mb-2' label="Professor" onClick={() => {
                    onTipoCadastroChange({ isProfessor: true, isCoordenador: false });
                    setActiveIndex(2);
                }} />
                <Button className='w-full mb-2' label="Coordenador" onClick={() => {
                    onTipoCadastroChange({ isProfessor: false, isCoordenador: true });
                    setActiveIndex(2);
                }} />
            </div>
        </div>
