# Generated by Django 4.2.6 on 2024-04-17 03:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grau_academico', models.CharField(blank=True, choices=[('TECNICO', 'Tecnico'), ('GRADUACAO', 'Graduacao'), ('POSGRADUACAO', 'Posgraduacao'), ('MESTRADO', 'Mestrado'), ('DOUTORADO', 'Doutorado'), ('POSDOUTORADO', 'Posdoutorado')], max_length=255, null=True)),
        ...
        migrations.AddField(
            model_name='tcc',
            name='coorientador',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='coorientador', to='app.professor'),
        ),
        migrations.AddField(
            model_name='tcc',
            name='orientador',
