...
urlpatterns = [
    ...
    path('download-ficha-avaliacao-preenchida/<int:avaliacaoId>/', views.DownloadFichaAvaliacaoView.as_view(), name='download-ficha-avaliacao-preenchida'),
    ...
    path('meus-cursos/', CursosUsuarioView.as_view(), name='meus-cursos'),
    path('curso/professores-internos/', ProfessoresInternosCursoView.as_view(), name='curso-professores-internos'),
